...
if load_model:
    load_checkpoint(torch.load("../result/saved_model/04-19-15-57.pth.tar"), seq2seq, optimizer)
...
# train_no_val(seq2seq, optimizer, fine_tune_train_iter, 15, "fine_tune_need")
